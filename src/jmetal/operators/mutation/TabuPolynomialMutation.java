...
import jmetal.problems.BodyCloudSensor.BodyCloudOptimization;
 ...
 */
public class TabuPolynomialMutation extends Mutation {
  ...
  private static List VALID_TYPES = Arrays.asList(RealSolutionType.class, ArrayRealSolutionType.class) ;
	 ...
	 */
	public TabuPolynomialMutation(HashMap<String, Object> parameters) {
		super(parameters) ;
		TabuTable = new int[BodyCloudOptimization.getNV()];
