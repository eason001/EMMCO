...
import jmetal.core.*;
import jmetal.problems.BodyCloudSensor.EGT;
 ...
 * random parents
 */
public class EGT_RandomSelection extends Selection {
  public EGT_RandomSelection(HashMap<String, Object> parameters) {
  	super(parameters) ;
  }
  ...
  */
  ...
  public Object execute(Object object) {
	  ...
	  //  System.out.println("=>p1 pos: " + pos1);
	  //  System.out.println("=>p2 pos: " + pos2);
	    Solution [] parents = new Solution[2];
	    parents[0] = population.get(pos1);
	    parents[1] = population.get(pos2);
	    jmetal.problems.OptMolCom.EGT.setp1Pos(pos1);
	    jmetal.problems.OptMolCom.EGT.setp2Pos(pos2);
	    return parents;
	  } // Execute     
} // RandomSelection
