...
public class NSGAII_main {
  ...
  public static int n_runs = 3; // 20 sim runs
  ...
  public static void main(String [] args) throws 
    ...
    logger_.info("Variables values have been writen to file VAR");
    population.printVariablesToFile("out\\NSGAII\\" + "VAR");    
    logger_.info("Objectives values have been writen to file FUN");
    population.printObjectivesToFile("out\\NSGAII\\" + "FUN");
  ...
  public static void writeResultToFile(String st, String filename) {
		try { // Create file
			FileWriter fstream = new FileWriter("out\\NSGAII\\" + filename, true);
