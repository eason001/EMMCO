...
public class NSGAIICS extends Algorithm {

	/**
	 * Constructor
	 * @param problem Problem to solve
	 */
	public NSGAIICS(Problem problem) {
		super (problem) ;
	} // NSGAII
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		while (evaluations < maxEvaluations) {
			...
			//	System.out.println(population.get(0).getObjective(0)+"   "+population.get(0).getObjective(1)+" "+population.get(0).getObjective(2));
				remain = 0;
			} // if                               
			...
			// than the hypervolume of the true Pareto front.
			 ...
			 if(evaluations%population.size()==0){
		    	  ...
		    	  System.out.println((double)HV);
		    	  writeResultToFile((double)HV+"","HV_NSGAII.txt");
		    	  ...
		    	  writeResultToFile(st1+" "+st2,"OBJS_NSGAII.txt");
