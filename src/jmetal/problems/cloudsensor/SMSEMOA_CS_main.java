...
public class SMSEMOA_CS_main {
	...
	ClassNotFoundException {
		...
		if (args.length == 1) {
			...
			problem =new CloudOptimization(100);
		...
		algorithm = new SMSEMOA_CS(problem);
    ...
    parameters = null ;
		...
		population.printVariablesToFile("VAR_SMS");
		logger_.info("Objectives values have been written to file FUN");
		population.printObjectivesToFile("FUN_SMS");
