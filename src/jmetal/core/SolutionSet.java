...
public class SolutionSet implements Serializable {
   ...
   * Copy.
   */
  public SolutionSet(SolutionSet ss) {
    solutionsList_ = new ArrayList<Solution>();
    for(int i=0;i<ss.getMaxSize();i++){
    	solutionsList_.add(ss.get(i));
    }
  } // SolutionSet
   ...
   * Copy.
   */
  public SolutionSet copy(SolutionSet ss) {
    SolutionSet resultSolutionSet = new SolutionSet(ss);
